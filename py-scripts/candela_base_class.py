...
def parse_the_args():
    ...
    parser.add_argument('--clients_type', help='Type of clients to use in the test: real or virtual or both', default='real')
    #NOt common
    #ping
    #without config
    parser.add_argument('--ping_num_sta',help="Number of stations to create for ping test", default=1, type=int)
